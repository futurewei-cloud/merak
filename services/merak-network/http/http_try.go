...
func main() {
	...
	vpcBody := vpc_struct{Network: vpcBody{
		AdminStateUp:        true,
		RevisionNumber:      0,
		Cidr:                "10.8.0.0/16",
		ByDefault:           true,
	...
	//	Project_id:            "123456789",
	//}
	call("http://54.188.252.43:30001/project/123456789/vpcs", "POST", vpcBody)
}

func call(url, method string, vpcBody interface{}) error {
	client := &http.Client{
		Timeout: time.Second * 10,
	}
	body, _ := json.Marshal(vpcBody)
