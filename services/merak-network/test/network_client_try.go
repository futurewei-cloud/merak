...
func main() {
	...
	testInternalNetConfigConfiguration := pb.InternalNetConfigConfiguration{
		...
		Networks:       []*pb.InternalNetworkInfo{&testInternalNetworkInfo},
		Storages:       []*pb.InternalStorageInfo{&testInternalStorageInfo},
		ExtraInfo:      []*pb.InternalNetConfigExtraInfo{&testInternalNetConfigExtraInfo},
	}
	testInternalNetConfigInfo := pb.InternalNetConfigInfo{
		OperationType: pb.OperationType_CREATE,
		Configuration: &testInternalNetConfigConfiguration,
	}
