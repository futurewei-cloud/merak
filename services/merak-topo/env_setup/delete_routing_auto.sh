...
#echo "172.xxx route added"
    ...
    #ssh -i ym-keypair.pem ubuntu@$hostIP "sudo route del -net 10.200.0.0/16 gw $ip"
    ssh -i ym-keypair.pem ubuntu@$hostIP "sudo route del -net 10.200.0.0 netmask 255.255.0.0"

    echo "$hostIP route deleted"
